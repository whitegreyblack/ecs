...
class EntityManager(object):
    ...
    def add(self, entity_id) -> None:
        """
        Adds an entity_id value to the list of used entity key values.
        If the key is not already used then it set the next_id to the most
        appropriate next id value.
        If the key is already used then it will raise a ValueError exception.
        """  
